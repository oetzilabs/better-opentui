...
export const Strikethrough = Schema.Literal(128).pipe(Schema.brand("Strikethrough"));
...
export const Input = Schema.Union(None, Bold, Dim, Italic, Underline, Blink, Inverse, Hidden, Strikethrough);
